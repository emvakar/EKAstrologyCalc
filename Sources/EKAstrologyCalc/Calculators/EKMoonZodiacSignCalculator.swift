//
//  EKMoonZodiacSignCalculator.swift
//  EKAstrologyCalc
//
...
public final class EKMoonZodiacSignCalculator {
    
    public init() { }
}

// MARK: - EKMoonZodiacSignCalculatorProtocol

extension EKMoonZodiacSignCalculator: EKMoonZodiacSignCalculatorProtocol {
